...
global t_resultados_es,t_resultados_in,busqueda, conn, conn1, bt_agregar, barra_texto, definicion, traducion, region_selected
...
bt_expresiones.place(x=325, y=440, width=150, height=50)

bt_agregar = Button(ventana_principal,bg="white",text="Agregar nueva", command=agregar_nueva)
bt_agregar.config(state="disabled")
bt_agregar.place(x=620, y=440, width=150, height=50)
